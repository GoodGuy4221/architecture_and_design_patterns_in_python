...
from patterns.generating_patterns import Engine, Logger, MapperRegistry
...
class CoursesList:
    ...
    def __call__(self, request):
        ...
        try:
            ...
            context['objects_list'] = category.courses
            context['name'] = category.name
            context['id'] = category.id
            return '200 OK', render('course_list.html', **context)
        except KeyError:
